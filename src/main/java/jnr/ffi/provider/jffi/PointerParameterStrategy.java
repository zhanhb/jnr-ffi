 ...
 *
 */
public final class PointerParameterStrategy extends ParameterStrategy<Pointer> {
    ...
    @Override
    public Object object(Pointer o) {
        return o.array();
    }

    @Override
    public int offset(Pointer o) {
        return o.arrayOffset();
    }

    @Override
    public int length(Pointer o) {
